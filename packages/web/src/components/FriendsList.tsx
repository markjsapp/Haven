    ...
    <div className="friend-row">
      ...
      <div className="friend-actions">
        {friend.status === "pending" && friend.is_incoming && (
          <>
            <button className="friend-action-btn accept" onClick={onAccept} title="Accept">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z" />
              </svg>
            </button>
            <button className="friend-action-btn decline" onClick={onDecline} title="Decline">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        {friend.status === "accepted" && (
          <>
            ...
            <button className="friend-action-btn decline" onClick={onRemove} title="Remove Friend">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" />
              </svg>
            </button>
        ...
        {friend.status === "pending" && !friend.is_incoming && (
          <button className="friend-action-btn decline" onClick={onRemove} title="Cancel Request">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" />
            </svg>
          </button>
